...
print("------------")
if mode == 'd':
    tempReadout = subprocess.check_output(['/home/supernemo/ADC_Monitoring/TempReadout_2.py', 'd'])
    tempString = tempReadout.rstrip("\n")
    print(tempString)
    statusString += "Temperature: \n" + "----------- \n" +tempString + "\n"
elif mode == 't':
    tempReadouttest = subprocess.check_output(['/home/supernemo/ADC_Monitoring/TempReadout_2.py', 't'])
