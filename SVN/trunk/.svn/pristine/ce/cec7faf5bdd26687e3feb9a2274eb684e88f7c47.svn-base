#include "./include/MOS_Plugin/pluginsBase.h"
#include "shell.h"
#include <cstring>
#include <cstdlib>
...
int shellPlugin::get(std::string value, int commandStringAck, std::vector<boost::any> *tabValue) {
		...
		m_cpt++;
		if(m_cpt>1) m_cpt=0;
		int ret2 = getDataAccessClientOPCUARef()->setDatapoint("CMS.GAS_System.Monitoring.status.status_v", 2,element);
	}
        return ret;
}
