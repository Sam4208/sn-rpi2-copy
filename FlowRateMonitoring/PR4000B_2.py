...
# -------------------------------------------
report_msg += "SP1 (Argon):" + set_point_ch1 
report_msg += "SP2 (Helium):" + set_point_ch2
report_msg += "FR1 (Argon):" + flow_ch1      
report_msg += "FR2 (Helium):" + flow_ch2
report_msg += "Range Ch1 (Argon):"   + range_unit_ch1
report_msg += " Range Ch2 (Helium):"  + range_unit_ch2
report_msg += " Scale Ch2 (Helium):"  + " " + scale_ch2
report_msg += " Status Ch2 (Helium):" + " " + status
report_msg += "\n"
